...
mat3=loadmat(r"AndrewNG ML\machine-learning-ex8\ex8\ex8_movies.mat")
mat4=loadmat(r"AndrewNG ML\machine-learning-ex8\ex8\ex8_movieParams.mat")
...
def  cofiCostFunc(params, Y, R, num_users, num_movies, num_features, Lambda): #returns reg cost and grad
    ...
    #compute regularized cost function (optimised for both X and theta)
...
movieList = open(r"AndrewNG ML\machine-learning-ex8\ex8\movie_ids.txt","r").read().split("\n")[:-1]
movieList # to load and see movies
